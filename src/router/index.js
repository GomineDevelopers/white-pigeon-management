...
const routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: "Contract",
        component: () =>
          import(/* webpackChunkName: "login" */ "../views/productapplication/ContractDownload.vue")
      },
      {
        path: "/historyflowdirectory",
        name: "HistoryFlowDirectory",
        component: () =>
          import(/* webpackChunkName: "login" */ "../views/bonusplan/HistoryFlowDirectory.vue")
      },
      {
        path: "/bonusplan",
        name: "BonusPlan",
        component: () => import(/* webpackChunkName: "login" */ "../views/bonusplan/BonusPlan.vue")
      },
      {
        path: "/verificationlist",
        name: "VerificationList",
        component: () =>
          import(/* webpackChunkName: "login" */ "../views/bonusplan/VerificationList.vue")
      },
      {
        path: "/mettingverification",
        name: "MettingVerification",
        component: () =>
          import(/* webpackChunkName: "login" */ "../views/bonusplan/MettingVerification.vue")
      },
      {
