<template>
  <el-row class="left_aside">
    ...
    >
      ...
      <el-menu-item index="/historyflowdirectory">
        <img src="../assets/image/jj.png" v-if="$route.path === '/historyflowdirectory'" />
        <img src="../assets/image/jj1.png" v-if="$route.path != '/historyflowdirectory'" />
